...
/*var slideshowInfo = document.getElementById('slideshowInfo');
		var slidesInfo = slideshowInfo.getElementsByTagName('img');
		var index = 0; 
		function prevInfoSlide() {
			slidesInfo[index].classList.remove('activeInfo');
			index = (index + 1) % slidesInfo.length;
			slidesInfo[index].classList.add('activeInfo');
		}
				function nextInfoSlide() {
			slidesInfo[index].classList.remove('activeInfo');
			index = (index - 1 + slidesInfo.length) % slidesInfo.length;
			slidesInfo[index].classList.add('activeInfo');
		}
*/
function Sim(sldrId) {
